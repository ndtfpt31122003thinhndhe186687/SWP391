...
public class DAO_Loan extends DBContext {
    ...
    public void UpdateLoanStatus( int loan_id,int customer_id){
        String sql = "update loan set status='complete' where loan_id=? and customer_id=?";
        try {
            PreparedStatement pre = con.prepareStatement(sql);
...
//        }
//        
          List<Loan_payments> l = d.getPaymentsByLoanIdandCustomerIdandStatus(1, 1);
