...
//                    }
                ...
                request.setAttribute("messagePenalty", "Bạn thanh toán trễ " + lateMonths
                        + " tháng. Phí phạt: " + formattedAmount + " VND");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (c.getAmount() < totalPrepayment) {
                ...
                d.UpdateCustomerAmount(c.getAmount() - totalPrepayment, c.getCustomer_id());
                //format tiền
                DecimalFormatSymbols symbols = new DecimalFormatSymbols(Locale.getDefault());
                symbols.setGroupingSeparator('.');
                DecimalFormat formatter = new DecimalFormat("#,###", symbols);
                String formattedAmount = formatter.format(totalPrepayment);
                request.setAttribute("message", "Tất toán thành công! Tổng tiền: " + formattedAmount + " VND");
            }
