                    ...
                    <div class="custom-block bg-white">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="password-tab-pane" role="tabpanel" aria-labelledby="password-tab" tabindex="0">
                                <h6 class="mb-4 text-danger" href="changepass">Password</h6>
                                <form class="custom-form password-form" action="changepass" method="post" role="form">
                                    ...
                                    <input type="password" name="newpass" id="confirm_password"  class="form-control" placeholder="New Password" required="">
