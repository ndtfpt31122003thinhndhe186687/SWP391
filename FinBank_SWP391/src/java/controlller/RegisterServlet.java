...
public class RegisterServlet extends HttpServlet {
    ...
    @Override
        ...
        String dobString = request.getParameter("dob"); // Lấy ngày sinh từ request
         String userTypeString = request.getParameter("usertype");
        String statusString = request.getParameter("status");
          String genderString = request.getParameter("gender");
        if (DAO.INSTANCE.existedAcc(email)) {
            ...
            User us = new User(0, fname, email, add, phone, add, p, add, add, add, phone, "");
