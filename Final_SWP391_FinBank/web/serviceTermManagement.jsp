                    ...
                    <tbody>
                        <c:forEach items="${requestScope.listSt}" var="s">
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${s.min_payment}" type="currency" currencySymbol="VND" groupingUsed="true" />
                                </td>
                                <td><fmt:formatNumber value="${s.min_deposit}" type="currency" currencySymbol="VND" groupingUsed="true" />
                                </td>
                                <td>
