    ...
    <body>
        ...
        <script>
            function validateForm() {
                ...
                const dobFeedback = document.createElement('div'); // Tạo phần hiển thị lỗi nếu chưa có
                dobFeedback.className = 'invalid-feedback';
                dobFeedback.style.color = 'red';
                if (age < 18 || (age === 18 && today < new Date(dobValue.getFullYear() + 18, dobValue.getMonth(), dobValue.getDate()))) {
                    dobFeedback.textContent = 'Bạn phải ít nhất 18 tuổi.';
                    dob.parentNode.appendChild(dobFeedback);
