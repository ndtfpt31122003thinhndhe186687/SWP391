 ...
 * @author Windows
 */
@WebServlet(name="InsurancePolicyDetailsServlet", urlPatterns={"/InsurancePolicyDetails"})
public class InsurancePolicyDetailsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsurancePolicyDetailsServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsurancePolicyDetailsServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
