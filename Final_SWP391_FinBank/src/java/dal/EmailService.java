    ...
    public static void sendReminder(String recipientEmail, double amount, String dueDate) {
        executorService.submit(() -> {
            try {
                ...
                SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd"); // Hoặc "yyyy/MM/dd"
                SimpleDateFormat outputFormat = new SimpleDateFormat("dd/MM/yyyy");
                Date date = inputFormat.parse(dueDate);
                String formattedDueDate = outputFormat.format(date);
                ...
                String htmlContent = "<p>Kính gửi Quý khách,</p>"
                        + "<p>Khoản vay của bạn cần thanh toán số tiền <b>" + formattedAmount + " VND</b> vào ngày <b>" + formattedDueDate + "</b>.</p>"
