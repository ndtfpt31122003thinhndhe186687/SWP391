...
public class Staff_managementFilter implements Filter {
    ...
    public Staff_managementFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("Staff_managementFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("Staff_managementFilter:DoAfterProcessing");
        }
...
//        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("Staff_managementFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("Staff_managementFilter()");
        }
        StringBuffer sb = new StringBuffer("Staff_managementFilter(");
