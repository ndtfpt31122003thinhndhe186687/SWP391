...
public class VerifyOtpServlet extends HttpServlet {
    ...
    private void sendConfirmationEmail(String recipientEmail) throws MessagingException {
        ...
        message.setSubject("Confirmation of Information Update");

        String emailContent = "Dear Valued Customer,\n\n"
                + "We are pleased to inform you that your information has been successfully updated in our system.\n\n"
                + "If you did not request this update, please contact our support team immediately to ensure your account security.\n\n"
                + "Thank you for choosing our services. We are committed to providing you with the best experience possible.\n\n"
                + "Best regards,\n"
