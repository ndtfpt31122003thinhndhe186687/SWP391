    ...
    public List<Insurance_transactions> getInsuranceTransactionByInsuranceID(int insurance_id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Insurance_transactions transactions = new Insurance_transactions
        (transaction_id, contract_id, contract_id, transaction_date, amount, transaction_type, notes);
    ...
    public List<Insurance_transactions> getInsuranceTransactionByInsuranceIDAndTransactionType(int insurance_id, String transaction_type) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String notes = rs.getString("notes");
                Insurance_transactions transactions = new Insurance_transactions(transaction_id, contract_id, contract_id, transaction_date, amount, transaction_type, notes);
                list.add(transactions);
            }
        } catch (Exception e) {
        }
