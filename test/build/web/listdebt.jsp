        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
                    ...
                    <!-- Search Form with Card Type Filter -->
                    <div class="mb-4">
                        <form method="get" action="listdebt" class="form-inline">
                            <div class="input-group">
                                ...
                                <select name="card_type" class="form-control">
                                    <option value="All" ${card_type == 'All' ? 'selected' : ''}>All Card Types</option>
                    ...
                    <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-center">
                            <c:if test="${currentPage > 1}">
                                <li class="page-item">
                                    <a class="page-link" href="listdebt?page=${currentPage - 1}&search=${search}&card_type=${card_type}">Previous</a>
                                </li>
                            </c:if>
                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <li class="page-item ${i == currentPage ? 'active' : ''}">
                                    <a class="page-link" href="listdebt?page=${i}&search=${search}&card_type=${card_type}">${i}</a>
                                </li>
                            </c:forEach>
                            <c:if test="${currentPage < totalPages}">
                                <li class="page-item">
                                    <a class="page-link" href="listdebt?page=${currentPage + 1}&search=${search}&card_type=${card_type}">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </nav>
