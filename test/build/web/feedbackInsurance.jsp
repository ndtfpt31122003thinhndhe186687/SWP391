...
.rating label:hover ~ label {
    color: gold; /* Khi chọn hoặc hover sẽ đổi màu */
}
    ...
    <input type="radio" id="star4" name="feedback_rate" value="4"><label for="star4">★</label>
    <input type="radio" id="star3" name="feedback_rate" value="3"><label for="star3">★</label>
    <input type="radio" id="star2" name="feedback_rate" value="2"><label for="star2">★</label>
    <input type="radio" id="star1" name="feedback_rate" value="1"><label for="star1">★</label>
</div>
</select>
