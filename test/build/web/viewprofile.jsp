                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-12">
                                ...
                                <p class="d-flex flex-wrap mb-2">
                                    ...
                                    <span><fmt:formatDate value="${customer.date_of_birth}" pattern="MMMM d, yyyy" /></span>
                                </p>
                                ...
                                <p class="d-flex flex-wrap">
                                    ...
                                    <span>$<fmt:formatNumber value="${customer.amount}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                                </p>
                                <p class="d-flex flex-wrap">
                                    <strong>Credit Limit:</strong>
                                    <span>$<fmt:formatNumber value="${customer.credit_limit}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                                </p>
                                <p class="d-flex flex-wrap">
                                ...
                                <p class="d-flex flex-wrap">
                                    ...
                                    <span>${customer.role_id}</span>
                                </p>

                                <h6 class="text-danger mt-4">Assets</h6>

                                <c:forEach var="asset" items="${assets}">
                                    <div class="custom-block-profile bg-light p-3 mb-3">
                                        <p class="mb-1"><strong>Asset ID:</strong> ${asset.asset_id}</p>
                                        <p class="mb-1"><strong>Description:</strong> ${asset.description}</p>
                                        <p class="mb-1"><strong>Value:</strong> $<fmt:formatNumber value="${asset.value}" type="number" minFractionDigits="2" maxFractionDigits="2"/></p>
                                        <p class="mb-1"><strong>Status:</strong> ${asset.status}</p>
                                    </div>
