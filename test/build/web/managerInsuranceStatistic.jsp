    ...
    <div class="row">
        ...
        <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
            <div class="title-group mb-3">
                <h1 class="h2 mb-0 text-danger">Quản lý thống kê của bảo hiểm</h1>
            </div>
            ...
            <div class="row statistic-section">
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số chính sách</div>
                        <div class="statistic-value">${totalPolicies}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số điều khoản</div>
                        <div class="statistic-value">${totalTerms}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
            ...
            <div class="row statistic-section">
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số hợp đồng</div>
                        <div class="statistic-value">${totalContract}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số giao dịch</div>
                        <div class="statistic-value">${totalTransaction}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
            ...
            <div class="row statistic-section">
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số chính sách đang hoạt động</div>
                        <div class="statistic-value">${activePolicys}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số điều khoản đang hoạt động</div>
                        <div class="statistic-value">${activeTerms}</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="statistic-card">
                        <div class="statistic-title">Tổng số hợp đồng đang hoạt động</div>
                        <div class="statistic-value">${activeContract}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="row statistic-section">
                ...
                <div class="col-md-6">
                    <div class="statistic-card">
                        <div class="statistic-title">Giới tính</div>
                        <table class="table">
                            <tr>
                ...
                <div class="col-md-6">
                    <div class="statistic-card">
                        <div class="statistic-title">Loại giao dịch</div>
                        <table class="table">
                            <tr>
                                <td>Thanh toán phí bảo hiểm:</td>
                                <td class="statistic-value">${payment}</td>
                            </tr>
                            <tr>
                                <td>Phí bảo hiểm chi trả:</td>
                                <td class="statistic-value">${claim}</td>
                            </tr>
                        </table>
                    </div>
                </div>
