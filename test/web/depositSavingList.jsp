                                ...
                                <div class="savings-item">
                                    ...
                                    <div id="${saving.savings_id}" class="savings-details" style="display: none;">
                                        <div class="savings-table">
                                            <div class="row"><span class="label">Số tiền đã gửi:</span><span class="value">$<fmt:formatNumber value="${saving.amount}" pattern="#,##0.00" /></span></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <span class="value">
                                                    <c:choose>
                                                        <c:when test="${saving.start_date >= vipStartDate}">
                                                            ${saving.interest_rate + savingsRateBonus}%
                                                            <c:if test="${savingsRateBonus > 0}">
                                                                (+${savingsRateBonus}% VIP)
                                                            </c:if>
                                                        </c:when>
                                                        <c:otherwise>
