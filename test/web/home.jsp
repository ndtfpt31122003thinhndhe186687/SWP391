                    ...
                    <c:if test="${sessionScope.account != null}">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="changeInfor">Xem hồ sơ</a></li>
                                        ...
                                        <li><a class="dropdown-item" href="staff_management?status=all&sort=full_name&type=&page=1&pageSize=2">Quản lý</a></li>
                                        </c:if>
                        ...
                        <c:if test="${sessionScope.account.role_id == 5}">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="sortInsurancePolicy?sortInsurancePolicy=none&status=all&quantity=5">Quản lý bảo hiểm</a></li>
                                    <li><a class="dropdown-item" href="logout">Đăng xuất</a></li>
                                </ul>
                            </li>                          
                        </c:if>
