...
public class DAO_Insurance extends DBContext {
    ...
    public static void main(String[] args) {
        ...
        int insurance_id = 2;
        int policy_id = 2;
        String term_name = "test";
        String term_des = "Pre-existing conditions are not covered.";
        Date start_date = Date.valueOf("2025-01-01");
        Date end_date = Date.valueOf("2030-01-01");
        String status = "active";
        Insurance_term t = new Insurance_term(insurance_id, policy_id, term_name, term_des, status, start_date, end_date);
        d.insertInsuranceTerm(t);
