...
public class AddInsuranceServlet extends HttpServlet {
    ...
    @Override
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String insurance_name = request.getParameter("insuranceName");
        ...
        try {
            DAO dao = new DAO();
            Insurance in = dao.getInsuranceByUsername(username);
            if(in!=null){
        ...
        dao.insertInsurances(role_id,username, password, insurance_name, email, phone_number, address, status);
         response.sendRedirect("managerInsurance");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
