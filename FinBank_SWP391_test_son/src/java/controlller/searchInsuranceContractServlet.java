 ...
 * @author Windows
 */
@WebServlet(name = "searchInsuranceContractServlet", urlPatterns = {"/searchInsuranceContract"})
public class searchInsuranceContractServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchInsuranceContractServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchInsuranceContractServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Insurance_contract> list = dao.searchInsuranceContractByCustomerName(i.getInsurance_id(), customer_name);
