    ...
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
            <div class="position-sticky py-4 px-3 sidebar-sticky">
                <ul class="nav flex-column h-100">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="managerInsurance">
                            <i class="me-2"></i>
                            Insurance Management
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="managerPolicy">
                            <i class="me-2"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="managerInsuranceCustomer">
                            <i class="me-2"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="managerInsuranceContract">
                            <i class=" me-2"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="managerInsuranceTransaction">
                            <i class="me-2"></i>
        ...
        <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
            <div class="title-group mb-3">
                <h1 class="h2 mb-0 text-danger">Insurance Management</h1>
            </div>
            ...
            <!-- View list staff -->
            <div class="mt-3">
                <a class="btn btn-success mb-2" href="addInsurance.jsp">Add New</a>
                    ...
                    <c:forEach items="${listIn}" var="I">
                        <tr>
                            ...
                            <td>${I.address}</td> 
                             <td>${I.status}</td> 
                            <td>
                                <a onclick="doDelete('${I.insurance_id}')" href="deleteInsurance?id=${I.insurance_id}" class="btn btn-danger">Delete</a>
                                <a href="updateInsurance?id=${I.insurance_id}" class="btn btn-success">Update</a> 
                            </td>
                        </tr>
                    </c:forEach>
                </table>
