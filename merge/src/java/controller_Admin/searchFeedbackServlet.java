...
public class searchFeedbackServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchFeedbackServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchFeedbackServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        DAO_Admin dao = new DAO_Admin();
         String customer_name = request.getParameter("searchName");
        ...
        List<Feedback> listF = dao.searchListFeedbackByCustomerName(customer_name);
        List<Feedback> listS = dao.getListServiceByFeedback();
