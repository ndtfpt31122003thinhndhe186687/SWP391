 ...
 * @author Windows
 */
@WebServlet(name="chooseInsurancePolicyServlet", urlPatterns={"/chooseInsurancePolicy"})
public class chooseInsurancePolicyServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet chooseInsurancePolicyServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet chooseInsurancePolicyServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
