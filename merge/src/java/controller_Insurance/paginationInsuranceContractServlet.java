 ...
 * @author Windows
 */
@WebServlet(name="paginationInsuranceContractServlet", urlPatterns={"/paginationInsuranceContract"})
public class paginationInsuranceContractServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet paginationInsuranceContractServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet paginationInsuranceContractServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        int count = dao.getTotalInsuranceContract(i.getInsurance_id());
