 ...
 * @author Windows
 */
@WebServlet(name="deleteInsuranceTermServlet", urlPatterns={"/deleteInsuranceTerm"})
public class deleteInsuranceTermServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet deleteInsuranceTermServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet deleteInsuranceTermServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       ...
       dao.deleteInsuranceTerm(term_id);
