 ...
 * @author Windows
 */
@WebServlet(name="paginationInsuranceTransactionServlet", urlPatterns={"/paginationInsuranceTransaction"})
public class paginationInsuranceTransactionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet paginationInsuranceTransactionServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet paginationInsuranceTransactionServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        int count = dao.getTotalInsuranceTransaction(i.getInsurance_id());
