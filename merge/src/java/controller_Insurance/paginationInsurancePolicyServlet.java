 ...
 * @author Windows
 */
@WebServlet(name = "paginationInsurancePolicyServlet", urlPatterns = {"/paginationInsurancePolicy"})
public class paginationInsurancePolicyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet paginationInsurancePolicyServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet paginationInsurancePolicyServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = dao.getTotalInsurancePolicy(i.getInsurance_id());
