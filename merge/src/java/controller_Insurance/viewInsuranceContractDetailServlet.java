 ...
 * @author Windows
 */
@WebServlet(name="viewInsuranceContractDetailServlet", urlPatterns={"/viewInsuranceContractDetail"})
public class viewInsuranceContractDetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet viewInsuranceContractDetailServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet viewInsuranceContractDetailServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
