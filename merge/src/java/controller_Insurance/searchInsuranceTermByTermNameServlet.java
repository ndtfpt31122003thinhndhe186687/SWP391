 ...
 * @author Windows
 */
@WebServlet(name="SearchInsuranceTermByTermNameServlet", urlPatterns={"/searchInsuranceTermByTermName"})
public class searchInsuranceTermByTermNameServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchInsuranceTermByTermNameServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchInsuranceTermByTermNameServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(term_name == null && term_name.trim().isEmpty() ){
            ...
            term_name = term_name.replaceAll("\\s+", " ");
            term_name = "%" + term_name.replace(" ", "%") + "%";
        }
        list = dao.searchInsuranceTermByTermName(i.getInsurance_id(), term_name);
