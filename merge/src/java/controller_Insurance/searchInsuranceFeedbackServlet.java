 ...
 * @author Windows
 */
@WebServlet(name="searchInsuranceFeedbackServlet", urlPatterns={"/searchInsuranceFeedback"})
public class searchInsuranceFeedbackServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchInsuranceFeedbackServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchInsuranceFeedbackServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Insurance_feedback> listF = dao.searchInsuranceFeedbackByCustomerName(
                customer_name, i.getInsurance_id());
        List<Insurance_feedback> listP = dao.getAllPolicyIDByFeedback(i.getInsurance_id());
