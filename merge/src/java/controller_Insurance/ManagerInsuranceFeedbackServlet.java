 ...
 * @author Windows
 */
@WebServlet(name="ManagerInsuranceFeedbackServlet", urlPatterns={"/ManagerInsuranceFeedback"})
public class ManagerInsuranceFeedbackServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManagerInsuranceFeedbackServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManagerInsuranceFeedbackServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
