    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (status.equals("approved")) {
            try {
                ...
                try (Connection conn = db.getConnection(); PreparedStatement pstmt = conn.prepareStatement(vipSql)) {
            ...
            loan_id = Integer.parseInt(loan_id_raw);
            sd.insertNotification(Integer.parseInt(customerId), loan_id,
                    "Vay", "Bạn đã bị hủy đơn. Nếu muốn thực hiện lại giao dịch, hãy điền lại thông tin!");
        }
        response.sendRedirect("customerrequest");
    }
