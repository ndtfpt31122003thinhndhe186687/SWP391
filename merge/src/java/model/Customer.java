...
public class Customer {
    ...
    public Customer(String insurance_name, String policy_name, String payment_frequency, int customer_id, int insurance_id, int loan_id, int duration, int policy_id, double CoverageAmount, double PremiumAmount, double PaidAmount, Date start_date, Date end_date) {
