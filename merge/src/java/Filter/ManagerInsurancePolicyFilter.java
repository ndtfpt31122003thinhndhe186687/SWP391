...
public class ManagerInsurancePolicyFilter implements Filter {
    ...
    public ManagerInsurancePolicyFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("InsurancePolicyManagerFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("InsurancePolicyManagerFilter:DoAfterProcessing");
        }
...
//        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("InsurancePolicyManagerFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("InsurancePolicyManagerFilter()");
        }
        StringBuffer sb = new StringBuffer("InsurancePolicyManagerFilter(");
