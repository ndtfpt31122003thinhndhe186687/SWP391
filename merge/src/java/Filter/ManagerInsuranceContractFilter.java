...
public class ManagerInsuranceContractFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("InsuranceContractManagerFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("InsuranceContractManagerFilter:DoAfterProcessing");
        }
...
//        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("InsuranceContractManagerFilter()");
        }
        StringBuffer sb = new StringBuffer("InsuranceContractManagerFilter(");
