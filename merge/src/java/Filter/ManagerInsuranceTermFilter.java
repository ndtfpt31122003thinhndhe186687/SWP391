...
public class ManagerInsuranceTermFilter implements Filter {
    ...
    public ManagerInsuranceTermFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("InsuranceTermManagerFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("InsuranceTermManagerFilter:DoAfterProcessing");
        }
...
//        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("InsuranceTermManagerFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("InsuranceTermManagerFilter()");
        }
        StringBuffer sb = new StringBuffer("InsuranceTermManagerFilter(");
