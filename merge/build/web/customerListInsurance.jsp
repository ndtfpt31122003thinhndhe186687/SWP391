        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="main-wrapper col-md-9 ms-sm-auto py-4 col-lg-9 px-md-4 border-start">
                        ...
                        <tbody>
                            <c:forEach var="c" items="${listC}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="toggleDetails('${c.loan_id}', '${c.insurance_id}', '${c.policy_id}')">Xem</a>


                                    </td>
                                </tr>
                                <tr id="details-${c.loan_id}-${c.insurance_id}-${c.policy_id}" class="hidden">
                    ...
                    <script>
                        function toggleDetails(loan_id, insurance_id, policy_id) {
                            console.log("Clicked with:", loan_id, insurance_id, policy_id);
                            let id = "details-" + loan_id + "-" + insurance_id + "-" + policy_id;
