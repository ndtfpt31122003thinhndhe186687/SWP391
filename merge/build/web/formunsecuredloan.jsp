...
<html>
    ...
    function updateDurationAndInterest() {
        ...
        if (selectedOption.value !== "") {
            ...
            // Tính số tiền có thể vay tối đa = (lương * 0.5) * số tháng vay
            var salary = parseFloat(salaryInput.value) || 0;
            var maxLoanAmount = (salary * 0.5) * parseInt(duration);
            amountInput.placeholder = "Số tiền vay tối đa: " + maxLoanAmount.toLocaleString("vi-VN") + " VND";
        } else {
            durationInput.value = "";
            interestRateInput.value = "";
            amountInput.placeholder = "Nhập số tiền vay";
        }
    }
</script>
    </head>
    <body>
        <div class="container">
            ...
            <form action="SendLoanReq" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="service_terms">kì hạn: </label>
                ...
                <div class="form-group">
                    <label for="salary">Số tiền cần vay:</label>
                ...
                <button onclick="location.href='SendLoanRequest'">Chuyển sang thế chấp</button>
