...
VALUES 
(1, 1, 5000000.00, GETDATE(), '2025-09-09', 'image1.jpg', 'Vay mua xe', 'approved', 'secured', 10000000.00, 'reducing_balance'),

(1, 2, 2000000.00, GETDATE(), '2026-12-09', 'image2.jpg', 'Vay du lịch', 'pending', 'unsecured', 0.00, 'fixed_principal'),

(1, 3, 10000000.00, GETDATE(), '2025-04-09', 'image3.jpg', 'Vay mua nhà', 'approved', 'secured', 20000000.00, 'reducing_balance');
...
select distinct feedbackInsurance.policy_id ,insurance_policy.policy_name from feedbackInsurance
